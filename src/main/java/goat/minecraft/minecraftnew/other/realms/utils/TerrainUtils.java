package goat.minecraft.minecraftnew.other.realms.utils;
        ...
        for (int dx = 0; dx < 16; dx++) {
            for (int dz = 0; dz < 16; dz++) {
                ...
                if (dist <= br + BEACH_IN) {
                    ...
                    boolean nearWater = isNearWater(tropicWorld, wx, wz, 2); // Check 2-block radius
                    ...
                    if (!nearWater && top > SEA_LEVEL + 2) {
                        ...
                        fillAirGapsWithSand(tropicWorld, wx, wz, cur, top);
