    ...
    public DamageCalculationResult calculateDamage(DamageCalculationContext context) {
        ...
        try {
            ...
            if (SkillTreeManager.getInstance() != null) {
                double bonus = 0.0;
                bonus += SkillTreeManager.getInstance().getTalentLevel(shooter.getUniqueId(), Skill.COMBAT, Talent.ARROW_DAMAGE_INCREASE_I) * 0.04;
                bonus += SkillTreeManager.getInstance().getTalentLevel(shooter.getUniqueId(), Skill.COMBAT, Talent.ARROW_DAMAGE_INCREASE_II) * 0.08;
                bonus += SkillTreeManager.getInstance().getTalentLevel(shooter.getUniqueId(), Skill.COMBAT, Talent.ARROW_DAMAGE_INCREASE_III) * 0.12;
                bonus += SkillTreeManager.getInstance().getTalentLevel(shooter.getUniqueId(), Skill.COMBAT, Talent.ARROW_DAMAGE_INCREASE_IV) * 0.16;
                bonus += SkillTreeManager.getInstance().getTalentLevel(shooter.getUniqueId(), Skill.COMBAT, Talent.ARROW_DAMAGE_INCREASE_V) * 0.20;
                if (bonus > 0) {
